                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div id="divToPrint">
                            ...
                            <h3><u>
                                <asp:Label ID="lblheader" runat="server" Text=""></asp:Label></u><asp:Label ID="lblclaimID" runat="server" Text=""></asp:Label></h3>
                            <br />
                            ...
                            <div id="divContent" runat="server">
                                <div class="inner-Content-container  table-responsive">
                                    <div class="InnerContentData">
                                        <div class="col-lg-12">
                                            <div class="form-group col-lg-12">
                                                <span class="col-lg-2">Approval Status :</span>
                                                <span class="col-lg-6">
                                                    <asp:Label ID="lblclaimstatus" Font-Bold="true" Font-Size="16px" runat="server"></asp:Label></span>
                                            </div>
                                            <div class="form-group col-lg-12">
                                                <span class="col-lg-2">Approval Date :</span>
                                                <span class="col-lg-6">
                                                    <asp:Label ID="lblapprovaldate" runat="server"></asp:Label></span>
                                            </div>
                                            <div class="form-group col-lg-12">
                            ...
                            <asp:TextBox ID="txtExpensePeriodto" Enabled="false" runat="server"></asp:TextBox>
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <span class="col-lg-6">
                                                    <asp:Label ID="lblprimaryActivites" runat="server"></asp:Label></span>
                                        ...
                                        <asp:TemplateField HeaderText="Particulars">
                                            <ItemTemplate>
                                                <%# DataBinder.Eval(Container.DataItem, "Description")%>
                                                            ...
                                                            <asp:BoundField HeaderText="Submission Type" DataField="submissionType" />
                                                            <asp:BoundField HeaderText="Remarks" DataField="Remarks" />
                                                            <asp:BoundField HeaderText="Expense Period from " DataField="ExpenseperiodFrom" DataFormatString="{0:dd-MMM-yyyy}" />
                                                            <asp:BoundField HeaderText="Expense Period to " DataField="ExpensePeriodTo" DataFormatString="{0:dd-MMM-yyyy}" />
                                                            <asp:BoundField HeaderText="Expense Place" DataField="Expenseplace" />
                                                        </Columns>
                                                    </asp:GridView>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <asp:Repeater runat="server" ID="gdvstatusdetails" >

                                                    <HeaderTemplate>
                                                        <table class="table table-bordered" >
                                                             <tr>
                                                                <td colspan="3" style="text-align:center; font-weight:bold;" class="bg-aqua-active">PM</td>
                                                                <td colspan="3" style="text-align:center; font-weight:bold;" class="bg-blue-active">KAM</td>
                                                               
                                                            </tr>
                                                            <tr class="bg-info" style="font-weight:bold; text-align:center;">
                                                    ...
                                                    <ItemTemplate>
                                                         <tr>
                                                                <td><%# Eval("PmStatus") %></td>
                                                                <td><%# Eval("pmApprovalON") %></td>
                                                                <td><%# Eval("PMname") %></td>
                                                                <td><%# Eval("KAMStatus") %></td>
                                                                <td><%# Eval("KamApprovalOn") %></td>
                                                                <td><%# Eval("Kamname") %></td>
                                                            </tr>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                            ...
                                            <%-- <div class="col-lg-12">
                                                <div class="col-lg-6 panel panel-info">
                                                    <div class="col-lg-12 panel-heading">
                                                        ...
                                                        <div class="col-lg-3">Approval PM</div>
                                                        <div class="col-lg-3">Approval Status </div>
                                                        <div class="col-lg-3">Approval On </div>
                                                        <div class="col-lg-3">Approval By </div>
                                                    </div>
                                                    <div class="col-lg-12 panel-body">
                                                        <div class="col-lg-3"></div>
                                                        <div class="col-lg-3">
                                                            <asp:Label ID="lblapprovalStatusPM" runat="server" Text="Pending"></asp:Label>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <asp:Label ID="lblapprovalONPM" runat="server" Text="Pending"></asp:Label>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <asp:Label ID="lblapprovedbyPM" runat="server" Text="Pending"></asp:Label>
                                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-6 panel panel-info">
                                                    <div class="col-lg-12 panel-heading">
                                                        <div class="col-lg-3">Approval KAM</div>
                                                        <div class="col-lg-3">Approval Status  </div>
                                                        <div class="col-lg-3">Approval On </div>
                                                        <div class="col-lg-3">Approval By </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 panel-body">
                                                        <div class="col-lg-3"></div>
                                                        <div class="col-lg-3">
                                                            <asp:Label ID="lblapprovalStatusKam" runat="server" Text="Pending"></asp:Label>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <asp:Label ID="lblapprovalOnKam" runat="server" Text="Pending"></asp:Label>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <asp:Label ID="lblapprovedByKam" runat="server" Text="Pending"></asp:Label>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        function getTotalEmployeeSalary() {
            ...
            $("#<%=gdvClaims.ClientID%> tr:has(td)").each(function () {
                ...
                if ($.trim($(this).find("td:eq(7)").text()) != "" && !isNaN($(this).find("td:eq(7)").text()))

                    sum = sum + parseInt($(this).find("td:eq(7)").text());
