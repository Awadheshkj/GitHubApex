<%@ Page Title="" Language="VB" MasterPageFile="settingmaster.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="CategoryManager.aspx.vb" Inherits="CategoryManager" %>
        ...
        <div class="bs-example form-horizontal">
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    ...
                    <asp:TextBox ID="txtCategory" runat="server"  class="form-control" MaxLength="40"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rvdCategory" runat="server" ErrorMessage="*" ControlToValidate="txtCategory" ForeColor="Red"></asp:RequiredFieldValidator>
