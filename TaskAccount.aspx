...
<ItemStyle HorizontalAlign="Left" Width="180px"></ItemStyle>
                        ...
                        <asp:TemplateField HeaderText="Notification Type" ItemStyle-Width="180px" ItemStyle-HorizontalAlign="Left" >
                            <EditItemTemplate>
                                 <asp:DropDownList ID='gv_ddlnotificationType' class='btn-small btn-info'  TabIndex="4" runat='server'>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "notificationType")%>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:DropDownList ID='ddlnotificationType' class='btn-small btn-info'  TabIndex="4" runat='server'>
                                      <asp:ListItem>Normal</asp:ListItem>
                                      <asp:ListItem>Quick</asp:ListItem>
                                 </asp:DropDownList>
                            </FooterTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="180px"></ItemStyle>
                        ...
                        <asp:TemplateField HeaderText="Action" ItemStyle-Width="160px">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Button CausesValidation="false" ID="imgbtnEdit" CommandName="Edit" visible='<%# IIf(CInt(ProcessMyDataItem(Eval("Claimed"))) > 0 Or CInt(ProcessMyDataItem(Eval("empadv"))) > 0 Or CInt(ProcessMyDataItem(Eval("vendadv"))) > 0, "false", "True")%>' runat="server" Text="Edit" CssClass="btn btn-sm btn-info" />
                                <asp:Button CausesValidation="false" ID="imgbtnDelete" OnClientClick="javascript:return ConfirmationBox()" visible='<%# IIf(CInt(ProcessMyDataItem(Eval("Claimed"))) > "0" Or CInt(ProcessMyDataItem(Eval("empadv"))) > 0 Or CInt(ProcessMyDataItem(Eval("vendadv"))) > 0, "false", "True")%>' CommandName="Delete" Text="Delete" runat="server" CssClass="btn-small btn-danger" />
                            </ItemTemplate>
                            <FooterTemplate>
