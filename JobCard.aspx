<%@ Page Title="" Language="VB" MasterPageFile="~/Apex.master" AutoEventWireup="false" CodeFile="JobCard.aspx.vb" Inherits="JobCard" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpFooter" runat="Server">
    ...
    <script>
        ...
        function FillLeadDetails() {
            ...
            $.ajax({
                url: "AjaxCalls/AX_Jobs.aspx?call=1",
                    ...
                    if (!Result == "") {
                        ...
                        for (var i = 0; i < jsonstr.Table.length; i++) {
                            ...
                            if (jsonstr.Table[i].PostPnLStatus.toString() == "N/A" || jsonstr.Table[i].JobCardNo.toString() == "N/A") {
                                ...
                                datatable += '<td><a href="PostPnLManager.aspx?jid=' + jsonstr.Table[i].JobCardID.toString() + '&mode=view"><span class="btn btn-sm btn-warning">Pending </span></a></td>'
                            }
                            else {
                        ...
                        $('#Docgrid tbody').on('click', 'span', function () {
        ...
        function FillinvoiceDetails(jcid) {
            ...
            var datatable1 = "";
            $.ajax({
                url: "AjaxCalls/AX_Jobs.aspx?call=7&jc=" + jcid,
                context: document.body,
                success: function (Result) {
