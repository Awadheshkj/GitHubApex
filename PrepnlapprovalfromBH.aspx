<%@ Page Title="" Language="VB" MasterPageFile="~/Apex.master" AutoEventWireup="false" CodeFile="PrepnlapprovalfromBH.aspx.vb" Inherits="OpenEstimate" %>
                          ...
                          <br />
                            ...
                            <asp:Button ID="btnsendrequesttobranchhead" class="btn btn-primary btn-sm pull-right" ValidationGroup="SA" runat="server" Text="Send" />
                                ...
                                <div class="InnerContentData">
                                     ...
                                     <div class="col-lg-12 table-responsive" id="prepnl">
                                                <h3 class="col-lg-12">Pre PnL for Approval</h3>
