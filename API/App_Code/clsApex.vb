        ...
        If bid <> "" Then
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                If Not IsDBNull(ds.Tables(0).Rows(0)("jobcompleted")) Then
                    If ds.Tables(0).Rows(0)("jobcompleted").ToString() = "Y" Then
                        flag = True
                    End If
                End If
            End If
    ...
    Public Shared Function GetJSONString(ByVal Dt As DataTable) As String
        ...
        For i As Integer = 0 To Dt.Rows.Count - 1
            ...
            For j As Integer = 0 To Dt.Columns.Count - 1
                If (Dt.Rows(i)(j).ToString().Contains("<")) Then
                    TempStr = TempStr.Replace(Dt.Columns(j).ToString() & j.ToString() & "¾", HttpUtility.UrlEncode(Dt.Rows(i)(j).ToString()))
                Else
