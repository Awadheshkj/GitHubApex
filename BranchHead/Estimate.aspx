                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="alert alert-success" id="Messagebranchhead" runat="server">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnsendrequesttobranchhead" class="btn btn-primary btn-sm pull-right" OnClick="btnAdd_Click" runat="server" Text="Send" />  
                        </div>
                            ...
                            <div class="inner-Content-container">
                                <div class="InnerContentData">
                                 ...
                                 <a href='javascript:history.go(-1)' class="btn btn-sm btn-primary">Back</a>
                                    <asp:Button runat="server" ID="btnAdd" Text="Save" CssClass="btn btn-sm btn-primary" TabIndex="10" />
