<%@ Page Title="" Language="VB" MasterPageFile="~/BranchHead/Apex.master" AutoEventWireup="false" CodeFile="OpenEstimate.aspx.vb" Inherits="OpenEstimate" %>
                            ...
                            <div class="inner-Content-container">
                                <div class="InnerContentData">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12" id="trGridEstimate" runat="server" >
                                            <asp:GridView runat="server" ID="gdvEstimate" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" AllowPaging="true" PageSize="50" ShowFooter="true">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Agency Fee(%)">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="gv__agencyfee" CssClass="form-control input-small" onkeyup="javascript:validdata1(this)" runat="server" MaxLength="5" Text='<%#Eval("AgencyFee") %>' />
                                                    ...
                                                    <asp:TemplateField HeaderText="Action" ItemStyle-Width="140px">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Button CausesValidation="false" ID="imgbtnEdit" CommandName="Edit" runat="server" OnClientClick="GVcalculation()" Text="Edit" CssClass="btn btn-sm btn-info" />
                                        ...
                                        <%--<asp:TextBox ID="txtServiceTax" Visible="false" runat="server" TabIndex="9" CssClass="form-control input-small" onkeyup="CalTotal1();" autocomplete="off"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" ControlToValidate="txtServiceTax" ForeColor="red"></asp:RequiredFieldValidator><asp:Label ID="lblServiceTaxPer" runat="server" Text='<%=ConfigurationManager.AppSettings("Servicetax").ToString()%>' SetFocusOnError="true"></asp:Label>--%>
                                            ...
                                            <div id="trAppButtons" class="col-lg-12" runat="server">
                                                ...
                                                <div class="col-lg-3" style="display: none;">
                                                    <asp:Button ID="btnApproval" runat="server" Text="Approve" CausesValidation="false" CssClass="btn btn-primary" TabIndex="25" />
                                                    <asp:Button ID="btnRejected" runat="server" Text="Reject" OnClientClick="javascript:return RejectConfirmationBox()" CausesValidation="false" CssClass="btn btn-primary" TabIndex="26" />
                                                </div>
                                 ...
                                 <a href='javascript:history.go(-1)' class="btn btn-primary">Back</a>
                                    ...
                                    <asp:Button runat="server" ID="btnExcel" Text="Export To Excel" CssClass="btn btn-primary" style="display:none;"  TabIndex="12"  /></div>
                                </center>
                                            </div>
                                        </asp:Panel>
        ...
        function CalTotal() {
            if (CalMFee() == true) {
                var EstTotal = document.getElementById('<%=lblSubTotal.ClientID%>').textContent;
                 ...
                 //var GrandTotal1 = parseInt(CalculatedTotal) * (parseInt(STAX)/100);
                 //document.getElementById('<%=lblServiceTax.ClientID%>').textContent = GrandTotal1;
                 //alert(GrandTotal1);
                 //var GrandTotal = CalculatedTotal + GrandTotal1;

                 //document.getElementById('<%=lblGrandTotal.ClientID%>').textContent = GrandTotal;

                 //document.getElementById('<%=hdnGrand.ClientID%>').value = GrandTotal;

                 //document.getElementById('<%=hdnTotal.ClientID%>').value = CalculatedTotal;
             }
         }
