<%@ Page Title="" Language="VB" MasterPageFile="~/BranchHead/Apex.master" AutoEventWireup="false" CodeFile="JobCardManager.aspx.vb" Inherits="JobCardManager" %>
                    ...
                    <div class="box-body">
                        ...
                        <div id="divContent" runat="server">
                            ...
                            <div class="col-lg-12" id="jobcard" >
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="col-lg-7" id="tdcontactinfo">Email:<asp:Label ID="lblCBEmail" runat="server"></asp:Label>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <span class="col-lg-2">Client Approval</span>
                                        <span class="col-lg-3">
                                            <asp:Label ID="lblApproval" runat="server"></asp:Label>
                                            <asp:CheckBox ID="chkApproval" runat="server" TabIndex="13" />
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <span class="col-lg-3">
                                            ...
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator12" SetFocusOnError="true" runat="server" ErrorMessage="*" ControlToValidate="txtApprovalDate" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                        </span>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <span class="col-lg-2">Approved By</span>
                                        <span class="col-lg-3">
                                            ...
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator13" SetFocusOnError="true" runat="server" ErrorMessage="*" ControlToValidate="ddlApprovedBy" ForeColor="Red" InitialValue="0"></asp:RequiredFieldValidator>--%>
                                        </span>
                            ...
                            <asp:Label ID="lblCApproveContact" runat="server"></asp:Label>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <span class="col-lg-2">Approval mail</span>
                                        <span class="col-lg-3">
                                            <asp:FileUpload ID="fupl_Mail" runat="server" Visible="false" onchange="javascript:return CheckUpl();" />
                                        ...
                                        <p style="padding-top:10px; "></p>    
                                            ...
                                            <asp:Button ID="btnverify" runat="server" Visible="false"  Text="Verify" CssClass="btn btn-sm btn-primary" />
                                            <asp:Button ID="btnreject" runat="server" Visible="false" Text="Reject" CssClass="btn btn-sm btn-primary" />
                                            <asp:HiddenField ID="hdnlblfulpl_Mail" runat="server" />
                                        </span>
                                    </div>
                                    <div class="col-lg-12" style="text-align: center" Visible="false" id="btns" runat="server" >
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpFooter" runat="Server">
    ...
    <script>
        ...
        function bindclient() {
            var JSONworkTypes = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_leads.aspx?call=4",
                context: document.body,
                success: function (Result) {
        ...
        function BindContactLabels(cpid) {
            if (cpid == "Add new") {
                ...
                if (cpid > 0) {
                    ...
                    $.ajax({
                        url: "../AjaxCallsBH/AX_Client.aspx?call=2&id=" + cpid,
                        context: document.body,
                        success: function (Result) {
                            if (Result != "") {
        ...
        function saveclientcontact() {
            ...
            { setTimeout("ShowMsg('Please select client')", 1) }
                ...
                if (cid > 0) {
                    $.ajax({
                        url: "../AjaxCallsBH/AX_leads.aspx?call=6&cid=" + cid + "&name=" + contactper + "&email=" + email + "&mob=" + mobile,
                        context: document.body,
                        success: function (Result) {
                            // alert(Result);
                            if (Result == "True") {
        ...
        function BindContactPerson() {
            ...
            if (cid > 0) {
                $.ajax({
                    url: "../AjaxCallsBH/AX_Client.aspx?call=1&id=" + cid,
                    context: document.body,
                    success: function (Result) {
                        if (Result != "") {
                            var JSONworkTypes = JSON.parse(Result);
