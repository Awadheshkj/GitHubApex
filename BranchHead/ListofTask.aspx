                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="150px">
                                                <ItemTemplate>
                                                    ...
                                                    <div class="btn btn-sm btn-primary" title="Upload" onclick="uploaddata(<%# Container.DataItemIndex + 0%>)" style='display:<%# IIf(Eval("insertedby").ToString() = clsMain.getLoggedUserID().ToString(), "", "none")%>'><i class="fa fa-upload"></i></div>
                                                    ...
                                                    <asp:LinkButton ID="btnaddRemarks" CssClass="btn btn-sm btn-primary" runat="server" visible='<%# IIf(Eval("insertedby").ToString() = clsMain.getLoggedUserID().ToString(), "True", "false")%>' Text="Save" OnClick="btnaddRemarks_Click" CommandArgument='<%# Eval("AccountID") %>'><i class="fa fa-save" ></i></asp:LinkButton>

                                                    <div class="btn btn-sm btn-primary" data-toggle="modal" data-target="#dialog-box-task" onclick='javascript:loadHistory(<%# DataBinder.Eval(Container.DataItem, "AccountID")%>)'>
                                                    ...
                                                    <a class="btn btn-sm btn-primary" visible='<%# IIf(Eval("insertedby").ToString() = clsMain.getLoggedUserID().ToString(), "True", "false")%>'  href="TaskAccount.aspx?jc=<%# Eval("refjobcardID")%>&tid=<%# Eval("refjobcardID")%>" title="Edit">
