<%@ Page Title="" Language="VB" MasterPageFile="~/BranchHead/Apex.master" AutoEventWireup="false" CodeFile="TravelPlan.aspx.vb" Inherits="TravelPlan" %>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Traval Plan List</h3>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpfooter" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function FillTravelDetails() {
            var datatable = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_TravelPlan.aspx?call=1", cache: false,
