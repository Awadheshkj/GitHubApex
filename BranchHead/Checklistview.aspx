<%@ Page Title="" Language="VB" MasterPageFile="~/BranchHead/Apex.master" AutoEventWireup="false" CodeFile="Checklistview.aspx.vb" Inherits="Checklistview" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpFooter" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fillTabKAM4Details() {
            ...
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=20&jid=" + GetParameterValues("jid"),
