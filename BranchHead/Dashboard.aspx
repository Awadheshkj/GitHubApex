<%@ Page Title="" Language="VB" MasterPageFile="~/BranchHead/Apex.master" AutoEventWireup="false" CodeFile="Dashboard.aspx.vb" Inherits="Dashboard" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpFooter" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fillNews() {
            var res = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=25",
        ...
        function fillJobCounts() {
            var datatable = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=22",
                context: document.body,
        ...
        function ClientWiseBarGraph() {
            ...
            var datatable = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=17",
                context: document.body,
        ...
        function CategoryWisePie() {
            var datatable = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=23",
                context: document.body,
        ...
        function ClientWiseBubble() {
            var datatable = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=24",
                context: document.body,
        ...
        function fillTabClientwiseDetails() {
            ...
            var datatable = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=15",
                context: document.body,
        ...
        function fillTabKAMwiseDetails() {
            ...
            var datatable = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=16",
                context: document.body,
        ...
        function fillTabFM4Details() {
            var datatable = "";
            $.ajax({
                url: "../AjaxCallsBH/AX_Dashboard.aspx?call=21",
                context: document.body,
    ...
    <script type="text/javascript">
        ...
        function fillTabPM1Detailssearch() {
            ...
            var urls = "../AjaxCallsBH/PMDetails.aspx?call=5";

            $.ajax({

                //url: "../AjaxCallsBH/PMDetails.aspx?call=5", cache: false,
