                                ...
                                <div class="InnerContentData">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-info">
                                            <div class="panel-heading">Brief Manager
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Category">
                                                                    <EditItemTemplate>
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredValidator2" ValidationGroup="Editvalidation" runat="server" ErrorMessage="*" ForeColor="Red" Display="Dynamic" ControlToValidate="gv_ddlCategory" InitialValue="Select"></asp:RequiredFieldValidator>
                                                                    </EditItemTemplate>
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Action" FooterStyle-Width="150px" ItemStyle-Width="150px">
                                                                    <EditItemTemplate>
                                                                        ...
                                                                        <asp:Button ID="Button1" runat="server" CommandName="Update"  Text="Update" CssClass= "btn btn-sm btn-info"></asp:Button>
