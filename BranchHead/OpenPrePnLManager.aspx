<%@ Page Title="" Language="VB" MasterPageFile="~/BranchHead/Apex.master" AutoEventWireup="false" CodeFile="OpenPrePnLManager.aspx.vb" Inherits="OpenPrePnLManager" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
                        ...
                        <asp:Panel ID="Panel1" runat="server">
                            ...
                            <div id="divContent" runat="server">
                                ...
                                <div id="tbl2" runat="server" class="col-lg-12">
                                    ...
                                    <asp:GridView ID="gvPrePnLCost" runat="server" DataKeyNames="Row" AutoGenerateColumns="false" Enabled="false"  ShowFooter="true" PageSize="5"
