...
Partial Class BriefManager
        ...
        Try
            ...
            If activity <> "" Then
                ...
                If checkDuplicateBriefName() = False Then
                    ...
                    sqlInsertString &= "           )OUTPUT Inserted.BriefID"
                    ...
                    Dim BriefID As Integer = 0
                    If BriefID = ExecuteSingleResult(sqlInsertString, _DataType.Numeric) > 0 Then
                        insertbriefHistory(BriefID)
    ...
    Private Sub insertbriefHistory(ByVal briefID As Integer)
        Try
            Dim sqlInsertString As String = ""
            Dim ActivityDate As String = ""
            ...
            sqlInsertString &= "INSERT INTO [APEX_BriefHistory]"
            sqlInsertString &= "           (BriefID,[BriefName]"
            sqlInsertString &= "           ,[PrimaryActivityID]"
            sqlInsertString &= "           ,[RefActivityTypeID]"
            sqlInsertString &= "           ,[RefClientID]"
            sqlInsertString &= "           ,[RefContactPersonID]"
        ...
        Try
            ...
            If activity <> "" Then
                ...
                If ExecuteNonQuery(sqlUpdateBriefString) > 0 Then
                    insertbriefHistory(hdnBriefID.Value)
                    InsertPrePnLInfo()
                    ...
                    Else
                        ...
                        role = capex.GetRoleNameByUserID(getLoggedUserID())
                        If role = "O" Then
                            Response.Redirect("PrePnlManager.aspx?jc=" & hdnJobCardID.Value & "&mode=edit&bid=" & hdnBriefID.Value)
