<%@ Page Title="" Language="VB" MasterPageFile="~/Apex.master" AutoEventWireup="false" CodeFile="RptOverallProject.aspx.vb" Inherits="RptOverallProject" %>
    ...
    <script>
        ...
        function getRole() {
            ...
            function fillTabKAM3Details() {
                ...
                $.ajax({
                    url: "AjaxCalls/AX_Dashboard.aspx?call=14&Searchtype=" + Searchtype + "&ddlorder=" + ddlorder + "&txtsearch=" + txtsearch + "&ddlstatus=" + ddlstatus,
                    context: document.body,
            ...
            function fillTabKAM4Details() {
                ...
                $.ajax({
                    url: "AjaxCalls/AX_Dashboard.aspx?call=20",
                    context: document.body,
            ...
            function fillRM() {
                var datatable = "";
                $.ajax({
                    url: "AjaxCalls/AX_Dashboard.aspx?call=19",
                    context: document.body,
