                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div id="divToPrint">
                            ...
                            <div id="divwarning" runat="server" class="alert alert-warning">
                                <p>
                                    <span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span>
                                    <strong>Warning: </strong>
                        ...
                        <span class="col-lg-2">Total Pending Approvals</span>
                                            ...
                                            <div class="col-lg-12" style="text-align: center" id="divPMpannel" runat="server" >
                                            ...
                                            <div class="col-lg-12" style="text-align: center" id="divkampannel" runat="server" >

                                                <asp:Button ID="btnKamApproved" runat="server" Text="Approved" CssClass="btn btn-primary" />


                                                <asp:Button ID="bntKamReject" runat="server" Text="Reject" CssClass="btn btn-primary" OnClientClick="javascript:return RejectConfirmationBox()" />
                                            </div>
