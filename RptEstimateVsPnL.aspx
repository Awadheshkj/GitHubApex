<%@ Page Title="" Language="VB" MasterPageFile="~/Apex.master" AutoEventWireup="false" CodeFile="RptEstimateVsPnL.aspx.vb" Inherits="RptEstimateVsPnL" %>
                    ...
                    PagerSettings-Mode="NumericFirstLast"  Width="100%">--%>
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Profit">
                                                <ItemTemplate>
                                                   <%-- <%# Eval("NetRevenueactual") %> - <%# Eval("posteventTotal") %>--%>
                                                    <%# Decimal.Parse(Eval("NetRevenueactual").ToString()) - Decimal.Parse(IIf(Convert.ToString(Eval("posteventTotal")) = "", "0", Eval("posteventTotal")).ToString()) %>
                                               <%--<%#IIf(Convert.ToString(Eval("posteventTotal")) = "", "0", Eval("posteventTotal"))%>--%>
                                                </ItemTemplate>
