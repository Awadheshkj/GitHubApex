                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <asp:Button ID="btnBrief" runat="server" Text="Convert to Brief" CausesValidation="false" CssClass="btn btn-primary" TabIndex="34" />
                                    ...
                                    <asp:Panel ID="Naction" runat="server">
                                        <div class="col-lg-5">
                                            <div class="form-group col-lg-12">
                                                <b>"Client Communication Tracking"</b>
                                            </div>
                                            <div class="form-group col-lg-12">
                                                <span class="col-lg-4">Next Action Step*</span>
                                                <span class="col-lg-7">
                                                    <asp:TextBox ID="txtnextactionStep" runat="server" CssClass="form-control" TabIndex="9" MaxLength="500"></asp:TextBox>
                                                </span>

                                                <span class="col-lg-1">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" SetFocusOnError="true" runat="server" ValidationGroup="NX" ControlToValidate="txtnextactionStep" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="form-group col-lg-12">
                                                <span class="col-lg-4">Action Date*</span>
                                                <span class="col-lg-7">
                                                    <asp:TextBox ID="txtactiondate" runat="server" onkeypress="return false" onkeyup="return false" onkeydown="return false" CssClass="form-control" TabIndex="9"></asp:TextBox>
                                                </span>

                                                <span class="col-lg-1">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" SetFocusOnError="true" runat="server" ValidationGroup="NX" ControlToValidate="txtactiondate" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <span class="col-lg-5">
                                                    ...
                                                    <asp:Button ID="btnaddactionstep" runat="server" Text="Add" ValidationGroup="NX" CssClass="btn btn-primary" TabIndex="14" />
                                                </span>
                                            ...
                                            <div class="form-group col-lg-12">
                                                <asp:GridView runat="server" ID="gdvLeadHistory" ShowHeader="true" ShowHeaderWhenEmpty="true"  CssClass="table table-bordered table-striped" AutoGenerateColumns="false">
                                                    <EmptyDataTemplate>
                                                        <div>
                                                            Data Not Available...
                                                        </div>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="NextActionStep" HeaderText="Next Action Step"/>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpFooter" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('input[id$=txtClosureDateTime]').datepicker({ format: 'dd-mm-yyyy', autoclose: true });
            $('input[id$=txtactiondate]').datepicker({ format: 'dd-mm-yyyy', autoclose: true });
        });
