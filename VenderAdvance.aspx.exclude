<%@ Page Title="" Language="VB" MasterPageFile="~/Apex.master" AutoEventWireup="false" CodeFile="VenderAdvance.aspx.vb" Inherits="EmployeeAdvance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('input[id$=txtpaymenttobedone]').datepicker({ dateFormat: 'dd-mm-yy' });
            $('input[id$=txtexpecteddateofexpences]').datepicker({ dateFormat: 'dd-mm-yy' });
                    ...
                    <div class="col-12">
                        <table class="table table-bordered" width="97%">
                            ...
                            <tr>
                                <td align="left" width="49%">JC #</td>
                                <td align="left" width="49%">
                                    <asp:TextBox ID="TextBox1" runat="server" MaxLength="50" CssClass="right_textbox"></asp:TextBox></td>
                            </tr>
                            <tr>
