...
Partial Class AjaxCalls_AX_Jobs
    ...
    Private Function FillJobDetails() As String
        ...
        sql &= " ,isnull(j.isinvoiceing,'N')isinvoiceing,j.RefActivityID "
        ...
        'End If
        sql &= "   where b.IsActive='Y' and b.IsDeleted='N' and j.IsEstimated='Y' and j.PrimaryActivityID ='" & role & "'"
        sql &= " or j.RefActivityID Like '%'+(select ProjectType from [dbo].[APEX_ActivityType] where projectTypeID='" & role & "')+'%' "
