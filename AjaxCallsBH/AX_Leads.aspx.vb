...
Partial Class AjaxCalls_AX_Leads
    ...
    Private Function FillLead() As String
        ...
        sql &= "  when JobCardNo is null then 'Open' else 'Closed' End,LeadName,l.RefActivityTypeID  From APEX_Leads as l   "
        ...
        ' If role = "BHE" Then
        sql &= " where l.IsActive = 'Y' and l.IsDeleted = 'N' and l.primaryActivityID='" & role & "'  "
        sql &= " or l.RefActivityTypeID Like '%'+(select ProjectType from [dbo].[APEX_ActivityType] where projectTypeID='" & role & "')+'%' "
        sql &= "  order by l.leadid Desc  "
        'End If
